...
public class SlotTabletDecoder extends Slot {
    /** The player that is using the GUI where this slot resides. */
    private EntityPlayer thePlayer;
    private int field_75228_b;

    public SlotTabletDecoder(EntityPlayer par1EntityPlayer,
	...
	if (!this.thePlayer.worldObj.isRemote) {
	    ...
	    float var3 = RecipesTabletDecoder.decoding().getExperience(
